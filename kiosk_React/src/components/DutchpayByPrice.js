                            ...
                            {items.map((item, index) => (
                                (
                                    <ul key={item.id}>
                                        ...
                                        <li>
                                            <input type="text" id={item.id} value={item.price} onChange={(e) => handlePriceChange(item.id, parseInt(e.target.value))} onClick={(e) => {handleNumPad(e, this); setNumpadModalShow(items.length > 1); }}/>
